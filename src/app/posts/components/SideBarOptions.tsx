...
export const SideBar = () => {
  ...
  return (
    <aside className="hidden md:block border-r border-gray-500 p-4 right-0 w-80 bg-white">
      <div className="flex flex-col items-center justify-start h-full">
        <section className="w-full mb-2">
          <ul className="relative flex flex-col items-start justify-center h-auto w-full">
            <li className="w-full hover:bg-gray-200 my-1 p-2 rounded-md">
            ...
            <li className="w-full hover:bg-gray-200 my-1 p-2 rounded-md">
              <button className="flex items-center space-x-2 w-full">
                <ChatBubbleBottomCenterTextIcon className="h-8 w-8 text-gray-500" />
